...
const objectLit = (key1, key2, key3) => `${key1} ${key2} ${key3}`;

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(objectLit('Hello','there,','how are ya?'));
...
// The window because with arrow functions, they bubble up.

// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions will bubble up to the next function, therefore this will reference any instances; whereas joe.scope() (for example) uses this and references a constructor function. 
